 ...
 */
max_run_t *ColSum_writeLMem_nonblock(
	int64_t param_address,
	int64_t param_nbytes,
	const void *instream_cpu_to_lmem);
 ...
 */
void ColSum_writeLMem_run(
	max_engine_t *engine,
	ColSum_writeLMem_actions_t *interface_actions);
 ...
 */
max_run_t *ColSum_writeLMem_run_nonblock(
	max_engine_t *engine,
	ColSum_writeLMem_actions_t *interface_actions);
 ...
 */
void ColSum_writeLMem_run_group(max_group_t *group, ColSum_writeLMem_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *ColSum_writeLMem_run_group_nonblock(max_group_t *group, ColSum_writeLMem_actions_t *interface_actions);
 ...
 */
void ColSum_writeLMem_run_array(max_engarray_t *engarray, ColSum_writeLMem_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *ColSum_writeLMem_run_array_nonblock(max_engarray_t *engarray, ColSum_writeLMem_actions_t *interface_actions[]);
 ...
 */
max_actions_t* ColSum_writeLMem_convert(max_file_t *maxfile, ColSum_writeLMem_actions_t *interface_actions);
 ...
 * \return A handle on the execution status, or NULL in case of error.
 */
max_run_t *ColSum_readLMem_nonblock(
	int64_t param_address,
	int64_t param_nbytes,
	void *outstream_lmem_to_cpu);
 ...
 * \param [in,out] interface_actions Actions to be executed.
 */
void ColSum_readLMem_run(
	max_engine_t *engine,
	ColSum_readLMem_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *ColSum_readLMem_run_nonblock(
	max_engine_t *engine,
	ColSum_readLMem_actions_t *interface_actions);
 ...
 * Run the actions on the first device available in the group.
 */
void ColSum_readLMem_run_group(max_group_t *group, ColSum_readLMem_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *ColSum_readLMem_run_group_nonblock(max_group_t *group, ColSum_readLMem_actions_t *interface_actions);
 ...
 * must match the size of engarray.
 */
void ColSum_readLMem_run_array(max_engarray_t *engarray, ColSum_readLMem_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *ColSum_readLMem_run_array_nonblock(max_engarray_t *engarray, ColSum_readLMem_actions_t *interface_actions[]);
 ...
 * \return The dynamic-interface actions to run, or NULL in case of error.
 */
max_actions_t* ColSum_readLMem_convert(max_file_t *maxfile, ColSum_readLMem_actions_t *interface_actions);
